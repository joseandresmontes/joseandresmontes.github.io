...
However, costs associated with the underdevelopment of the domestic seaweed industry paired with high export demand have made the material unaffordable for the local economy. With the exception of South Sulawesi, whose production eclipses the aggregate of remaining regions, the lack of unified farming practices, harvesting protocol, and post-harvest processing control render supply vulnerable to volatile pricing, climatic shocks, and inconsistent quality. In addition, downstream final products and operations also require affordable financing as businesses seek to transition into using seaweed-based bioplastics.
...
![image-center](/images/sustainability-investing-challenge/blue-rates.png){: .align-center} 
...
![image-center](/images/sustainability-investing-challenge/example-rate.png){: width=10%} 
...
![image-center](/images/sustainability-investing-challenge/net-revenue.png){: .align-center}
